    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Track your monthly spending</p>
        </div>
        <button
      ...
      <div className="flex items-center justify-center h-64 rounded-2xl bg-white border border-dashed border-gray-200">
        <div className="text-center">
          ...
          <p className="text-base font-semibold text-gray-700">No expenses this month</p>
          <p className="text-sm text-gray-400 mt-1">Log your expenses to track where your money goes</p>
        </div>
      </div>
    </div>
  )
